transforms_kwargs = dict(interpolations=("bicubic", "nearest-exact", "nearest-exact", "nearest-exact"), max_stride=64, size_bucket_config=dict(scale=1), batched_resize=True)
...
train_dataset_tag = 'pair_label'

train_dataset_kwargs1 = dict(image_keys=('image', 'mask', 'thing_score_mask', "entity_proportion_mask"), transforms_kwargs=transforms_kwargs,
                            image_modes=("RGB", "L", "L", "L"), collect_keys=('image', 'mask', 'inpainting_mask', 'text'),)
train_dataset_tag1 = 'non_pair_label'
